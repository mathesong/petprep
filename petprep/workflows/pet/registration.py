    ...
    if pet2anat_method == 'ants':
        coreg = pe.Node(
            Registration(
                ...
                transforms=['Affine', 'Rigid'],
                transform_parameters=[(0.1,), (0.1,)],
                metric=['MI', 'MI'],
                metric_weight=[1, 1],
                radius_or_number_of_bins=[32, 32],
                sampling_strategy=['Random', 'Random'],
                sampling_percentage=[0.6, 0.6],
                number_of_iterations=[[500, 250, 100], [1000, 500, 250]],
                convergence_threshold=[1e-5, 1e-5],
                convergence_window_size=[20, 20],
                shrink_factors=[[4, 2, 1], [4, 2, 1]],
                smoothing_sigmas=[[3, 2, 1], [3, 2, 1]],
                sigma_units=['vox', 'vox'],
